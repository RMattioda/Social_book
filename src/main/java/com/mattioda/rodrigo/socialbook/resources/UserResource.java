...
public class UserResource {
	...
	public ResponseEntity<List<UserDto>> findAll() {
		...
		// O map vai pegar cada um dos elementos do objeto que roda na query e passa
		// para o objeto DTO que por fim
	...
	public ResponseEntity<Void> insert(@RequestBody UserDto userDto) {
		...
		// Created traz o código 201 (que é o código de quando você cria um novo
		// recurso)
	...
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(name = "file") MultipartFile multipartFile) {
		...
		URI uri = userService.uploadProfitePicture(multipartFile);
		return ResponseEntity.created(uri).build();
	}
